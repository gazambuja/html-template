...
function closeNotice(){
    var notShow =  0;
    if($('#dontShowAgain').is(":checked")) notShow = 1;    
    $.ajax({
        type: "POST",
        url: url_close_notice,
